 ...
 */
public class GratuitousExtraUserTests extends BaseTest {
    ...
    @Test
    public void testLoginWithNewUser0() {
        String randomUserName = "usr" + UUID.randomUUID().toString().substring(0, 10).replace("-", "");
        User user = new User(randomUserName,"pass123",randomUserName + "@mailinator.com");
        CreateUserAction cuAction = new CreateUserAction(Browser,user);
        cuAction.execute();
    ...
    @Test
    public void testLoginWithNewUser1() {
        String randomUserName = "usr" + UUID.randomUUID().toString().substring(0, 10).replace("-", "");
        User user = new User(randomUserName,"pass123",randomUserName + "@mailinator.com");
        CreateUserAction cuAction = new CreateUserAction(Browser,user);
        cuAction.execute();
    ...
    @Test
    public void testLoginWithNewUser2() {
        String randomUserName = "usr" + UUID.randomUUID().toString().substring(0, 10).replace("-", "");
        User user = new User(randomUserName,"pass123",randomUserName + "@mailinator.com");
        CreateUserAction cuAction = new CreateUserAction(Browser,user);
        cuAction.execute();
    ...
    @Test
    public void testLoginWithNewUser3() {
        String randomUserName = "usr" + UUID.randomUUID().toString().substring(0, 10).replace("-", "");
        User user = new User(randomUserName,"pass123",randomUserName + "@mailinator.com");
        CreateUserAction cuAction = new CreateUserAction(Browser,user);
        cuAction.execute();
    ...
    @Test
    public void testLoginWithNewUser4() {
        String randomUserName = "usr" + UUID.randomUUID().toString().substring(0, 10).replace("-", "");
        User user = new User(randomUserName,"pass123",randomUserName + "@mailinator.com");
        CreateUserAction cuAction = new CreateUserAction(Browser,user);
        cuAction.execute();
